...
class TimeTableTeacherGenerate(report_sxw.rml_parse):
    ...
    def get_full_name(self, data):
        faculty_name = self.pool.get('ems.faculty').browse(
    ...
    def get_object(self, data):
        ...
        for timetable_obj in pooler.get_pool(self.cr.dbname).get(
            ...
            timetable_data = {
                ...
                'day': day,
                'class': timetable_obj.class_id.name,
                #'course': timetable_obj.course_id.name,
                #'edition': timetable_obj.edition_id.name,
            }
...
class ReportTimeTableTeacherGenerate(models.AbstractModel):
    _name = 'report.emsprime_timetable.report_timetable_teacher_generate'
    _inherit = 'report.abstract_report'
    _template = 'emsprime_timetable.report_timetable_teacher_generate'
